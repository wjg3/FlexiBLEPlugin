...
namespace FlexiBLE
{
     ...
     */
    class CalcFlexiBLEForceKernel : public KernelImpl
    {
    public:
        ...
        CalcFlexiBLEForceKernel(std::string name, const Platform &platform) : KernelImpl(name, platform)
        {
        }
        /**
         ...
         */
        virtual void initialize(const System &system, const FlexiBLEForce &force) = 0;
        /**
         ...
         */
        virtual void copyParametersToContext(ContextImpl &context, const FlexiBLEForce &force) = 0;
    };
